...
const list = async (req, res, next) => {
  try {
    ...
    const result = await categoriesService.getList(body, params, info);
...
const viewById = async (req, res, next) => {
  try {
    ...
    const result = await categoriesService.viewById(body, params, info);
...
const update = async (req, res, next) => {
  try {
    ...
    const result = await categoriesService.update(body, params, info);
...
const deleteById = async (req, res, next) => {
  try {
    ...
    const result = await categoriesService.deleteById(body, params, info);
